...
const links = [
  { href: "/artist/analytics", label: "Track analytics" },
  { href: "/artist/play-reports", label: "Play reports" },
  { href: "/artist/promote", label: "Featured Spotlight" },
  { href: "/artist/billing", label: "Billing" },
] as const;

export default function ArtistMorePage() {
  return (
    <div className="mx-auto flex w-full max-w-lg flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">More</h1>
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
          Analytics, billing, and account actions.
        </p>
      </div>
