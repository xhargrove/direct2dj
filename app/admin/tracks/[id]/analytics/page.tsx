  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-10">
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm">
        <Link href="/admin/tracks" className="text-zinc-600 underline dark:text-zinc-400">
          ← All tracks
        </Link>
        <Link href={`/admin/tracks/${id}`} className="text-zinc-600 underline dark:text-zinc-400">
          Track admin
        </Link>
      </div>
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
          Admin analytics — same metrics as artist-facing analytics; DJ names shown for moderation.
        </p>
      </div>
      ...
      <section className="rounded-lg border border-amber-200/80 bg-amber-50/50 p-4 dark:border-amber-900/60 dark:bg-amber-950/30">
        ...
        <p className="mt-2 text-xs text-zinc-600 dark:text-zinc-400">
          ...
          was active for this track (timestamp overlap with download time).
        </p>
      ...
      <section>
        <h2 className="text-lg font-semibold">DJs who engaged</h2>
        <p className="mt-1 text-xs text-zinc-500">DJs who downloaded and/or rated (admin view: display names).</p>
        {supporters.length === 0 ? (
